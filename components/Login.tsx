...
import { ArrowRight, User, Lock, Mail, UserPlus, AlertTriangle, CheckCircle, Key, Eye, EyeOff, ShieldCheck } from 'lucide-react';
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 text-center">
              <button 
                ...
                className="text-sm text-slate-500 hover:text-[#B38E5D] transition-colors font-medium"
              >
                {isRegistering 
